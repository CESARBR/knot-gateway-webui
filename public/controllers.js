...
appCtrls.controller('CloudController', function CloudController($scope, $state, GatewayApi, StateService, VIEW_STATES, API_STATES, CLOUD_PLATFORMS) {
  ...
  $scope.cloudPlatforms = [
    { name: 'KNOT_CLOUD', src: CLOUD_PLATFORMS.KNOT_CLOUD, selected: false, width: '90px', height: '90px' },
    { name: 'FIWARE', src: CLOUD_PLATFORMS.FIWARE, selected: false, width: '110px', height: '90px' }
  ];
